...
const PlaceOrderScreen = () => {
    ...
    const handlePlaceOrder=(shippingData,email)=>{
        fetch(`https://hekto.onrender.com/orders-placed/${email}`, {
            method: "PUT",
        ...
        // axios.post('https://hekto.onrender.com/place-orders', data).then(res => {
        ...
        // const url = `https://hekto.onrender.com/orders/delete/${email}`;
        // fetch(url, {
        //     method: 'DELETE',
        // })
        // .then(res => res.json())
